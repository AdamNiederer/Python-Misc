...
# Author: Joshua Li
# Description:
# 	An implementation of my own homebrew algorithm to the problem:
#	Given a list of numbers (-100 to 100), find the maximum sum
#	found in any contiguous subsequence of the list.

# Unlike brute force, which is O(n^2), my algorithm is O(n)!
...
# *** My algorithm will only work if a list is in this compressed format. ***
